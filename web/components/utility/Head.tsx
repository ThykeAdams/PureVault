...
const Head: FC<BaseProps> = ({ title }) => {
  ...
  return (
    <NHead>
      <title>{focused ? `${title ? `${title} | ` : ''} PureVault` : '🔒 PureVault 🔒'}</title>
      <meta name="title" content="Purevault"/>
<meta name="description" content="PureVault is a password and credential manager tailored for software professionals, emphasizing simplicity, efficiency, and security. It seamlessly integrates into various programming environments, offering advanced encryption, easy navigation, and features like version control and automated password updates. PureVault is the go-to solution for developers needing a secure, effective way to manage sensitive information."/>
